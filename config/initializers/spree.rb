...
if !Rails.env.test?
  ...
  Spree::SizingGuideImage.attachment_definitions[:attachment][:path] = 'spree/sizing_guides/:id/:style/:basename.:extension'
  Spree::SizingGuideImage.attachment_definitions[:attachment][:url] = 'spree/sizing_guides/:id/:style/:basename.:extension'
end

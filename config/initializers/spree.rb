...
if !Rails.env.test?
  ...
  Spree::Image.attachment_definitions[:attachment][:bucket] = Figaro.env.aws_s3_bucket ||= Figaro.env['aws_s3_bucket']
  Spree::Image.attachment_definitions[:attachment][:s3_credentials] = {
    access_key_id: Figaro.env.aws_access_key_id ||= Figaro.env['aws_access_key_id'],
    secret_access_key: Figaro.env.aws_secret_access_key ||= Figaro.env['aws_secret_access_key']
  }
  ...
  Spree::HomepageSlide.attachment_definitions[:image][:bucket] = Figaro.env.aws_s3_bucket ||= Figaro.env['aws_s3_bucket']
